...
class BukuModel
{
    ...
    {
        $this->db->query(
            'SELECT buku.*, kategori.nama_kategori FROM ' . $this->table .
    ...
    {
        $query = "INSERT INTO buku (judul, penerbit, pengarang, tahun, kategori_id, harga) 
    ...
    {
        $query = "UPDATE buku SET judul = :judul, kategori_id = :kategori_id WHERE id = :id";
        $this->db->query($query);
